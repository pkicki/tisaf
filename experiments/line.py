...
def main(args):
    ...
    experiment_handler.restore("./results/lines/checkpoints/last_n-10")
    ...
    for epoch in range(args.num_epochs):
        ...
        for i, task in _ds('Validation', val_ds, val_size, epoch, args.batch_size):
            ...
            model_loss, invalid_loss, curv_loss, last_length_loss, some_loss, x_path, y_path, th_path = plan_loss(
                output, data, env)
            ...
            with tfc.summary.record_summaries_every_n_global_steps(args.log_interval, val_step):
                ...
                tfc.summary.scalar('metrics/last_length_loss', last_length_loss, step=val_step)
                tfc.summary.scalar('metrics/curvature_loss', curv_loss, step=val_step)
